/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 417b9dc323489aca0313d01babd20bb9)
// Runtime types generated with workerd@1.20260217.0 2025-08-15 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker/index");
		durableNamespaces: "PayloadDatabaseDO";
	}
	interface Env {
		EVENTS_PIPELINE: import("cloudflare:pipelines").Pipeline<import("cloudflare:pipelines").PipelineRecord>;
		PAYLOAD_DO: DurableObjectNamespace<import("./src/worker/index").PayloadDatabaseDO>;
